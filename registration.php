            ...
            <div class="col-lg-4 offset-lg-4">
                ...
                <div class="upload-profile-image d-flex justify-content-center pb-5">
                    <div class="text-center">
                        <small class="form-text font-rubik text-light">Choose Your Avatar</small>
                        <div class="d-flex justify-content-center">
                            <img class="camera-icon" src="./assets/avatar/camera-solid.svg" alt="camera">
                        </div>
                        <img src="./assets/avatar/demo-avatar.png" style="width: 200px; height: 200px" class="img rounded-circle" alt="profile">
                ...
                <div class="d-flex justify-content-center">
                    <form action="registration.php" method="POST" enctype="multipart/form-data" id="reg-form">
                        ...
                        <div class="form-row my-4">
                            <div class="col">
                                <input type="password" required name="confirm-pwd" id="confirm-pwd" class="form-control" placeholder="Confirm Password*">
