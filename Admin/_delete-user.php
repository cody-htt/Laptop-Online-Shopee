...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    require('../Database/_delete-user.php');
}
?>
    ...
    <div id="page-inner">
        ...
        <div class="row">
            <div class="col-md-3 col-sm-6 col-xs-6">
                ...
                <table>
                    <form action="_delete-user.php" method="POST" enctype="multipart/form-data" id="delete-user-form">
                        <?php
                        ...
                        foreach ($user->getData() as $item):
                            if ($item['user_id'] == $item_id):
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" placeholder="Email" id="email" name="email"
                                               value=<?php echo($item["user_email"] ?? 'default') ?>></td>
                                </tr>
