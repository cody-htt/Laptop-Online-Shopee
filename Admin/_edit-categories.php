...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    require('../Database/_edit-categories.php');
}
?>
                                ...
                                <?php 
                                    ...
                                    foreach ($categories->getData() as $item):
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" placeholder="Name Categories" id="namecategories" name="namecategories" value=<?php echo($item["brand_name"]?? 'default') ?> > </td>
                                        </tr>
                                        <input type="text"  id="idcategories" name="idcategories" value=<?php echo($item["brand_id"]?? 'default') ?> hidden >
